...
//        SpringApplication.run(DividendsApplication.class, args);
        ...
        try {
            Connection connection = Jsoup.connect("https://finance.yahoo.com/quote/COKE/history?period1=99100800&period2=1690588800&interval=1mo&filter=history&frequency=1mo&includeAdjustedClose=true");
